...
import org.zframework.web.entity.SafeConfig;
...
public class SafeController extends BaseController<SafeConfig>{
	...
	public String index(Model model){
		...
		logService.recordInfo("查询安全管理","成功",getCurrentUser().getLoginName() , getRequest().getRemoteAddr());
		return "admin/safe/index";
	}
