...
public class SQLInterceptor implements HandlerInterceptor{
	...
	//private final String SQL_KEYWORDS = "'|and|exec|insert|select|delete|update|count|*|%|chr|mid|master|truncate|char|declare|;|or|,";
	private final String SQL_KEYWORDS = "'|exec|*|%|;";
	/**
	 * 检测参数中是否含有SQL关键字
	 * 如果含有则转向错误页面!
	 * 
